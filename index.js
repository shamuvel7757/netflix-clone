// Consts
const apikey = "841cbc39505463135bd676abba4a47d5";
...
const apiPaths = {
    ...
    searchOnYoutube: (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyDpkKvbGZLNBHUOxneg2oKeX4Fe7GS-l1o`
}
